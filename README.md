...
1. Statistics for the whole initial DIA library, contains:
    ...
    # Import mskit from src folder
   
    from mskit.post_analysis.spectronaut import SpectronautLibrary as SNLib
...
2. Filter the initial library to retain high-quality data for further use.
    ...
    ```shell script
    # use python ./src/filter_library.py --help to get the help text
    # An example usage:
    python ./src/filter_library.py -l /library/path -o /output/path -min 7 -max 30 -p 6 -c 1,2,3,4,5
    ```
...
1. Split the filtered initial library to training and test dataset.
    ...
    + Split the library based on the targeted protein family.
        ...
        ```shell script
        # use python ./src/generate_dataset.py --help to get the help text
        # An example usage:
        python ./src/generate_dataset.py -l /library/path -o /output/dir/ -t target/file/path
    ...
    + Split the library with a certain ratio.
        ...
        # use python ./src/generate_dataset.py --help to get the help text
        # An example usage:
        python ./src/generate_dataset.py -l /library/path -o /output/dir/ -r 8:2
...
3. Predict ion intensity and retention time.
    ...
    # use python ./src/input_from_fasta.py --help to get the help text
   
    # An example usage:
    python ./src/input_from_fasta.py -f /fasta/path -o /output/dir/ -min 7 -max 30 -mc 2 -c 2,3 -oxi 0
...
4. Combine ion intensity and retention time to generate a virtual library.
    ...
    ```shell script
    # use python ./src/merge_library.py --help to get the help text
    # An example usage:
    python ./src/merge_library.py -ion /pdeep/prediction/path -rt /deeprt/prediction/path -o /output/path
    ```
...
+ A hybrid library is generated by combining the initial DIA library and the targeted virtual library.
    ...
    # use python ./src/merge_library.py --help to get the help text
    # An example usage:
    python ./src/merge_library.py -dia /dia/library/path -vir /virtual/library/path -o /output/path
    ```
