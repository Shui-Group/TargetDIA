...
class HCD_test_yion_Config(BasicConfig):
    def __init__(self):
        super(self.__class__, self).__init__()
        self.SetIonTypes(['y{}'])


class HCD_Config(BasicConfig):
    def __init__(self):
        super(self.__class__, self).__init__()


class HCD_ProteomeTools_Config(BasicConfig):
    def __init__(self):
        super(self.__class__, self).__init__()


class ETD_Config(BasicConfig):
    def __init__(self):
        super(self.__class__, self).__init__()
...
class ETD_ProteomeTools_Config(BasicConfig):
    def __init__(self):
        super(self.__class__, self).__init__()
        self.SetIonTypes(['c{}','z{}'])
        self.fragmentation = 'ETD'
...
class EThcD_Config(BasicConfig):
    def __init__(self):
        super(self.__class__, self).__init__()
...
class EThcD_ProteomeTools_Config(BasicConfig):
    def __init__(self):
        super(self.__class__, self).__init__()
        self.SetIonTypes(['b{}','y{}','c{}','z{}'])
        self.fragmentation = 'EThcD'
...
class HCD_pho_Config(BasicConfig):
    def __init__(self):
        super(self.__class__, self).__init__()
...
class HCD_oxM_Config(BasicConfig):
    def __init__(self):
        super(self.__class__, self).__init__()
        self.SetIonTypes(['b{}','y{}'])
...
class HCD_CommonMod_Config(BasicConfig):
    def __init__(self):
        super(self.__class__, self).__init__()
        self.SetIonTypes(['b{}', 'y{}'])
...
class HCD_AllMod_Config(BasicConfig):
    def __init__(self):
        super(self.__class__, self).__init__()
        self.SetIonTypes(['b{}','y{}'])
...
class ETD_pho_Config(BasicConfig):
    def __init__(self):
        super(self.__class__, self).__init__()
        self.SetIonTypes(['c{}','z{}'])
